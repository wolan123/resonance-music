...
一个真正的共享音乐网站：任何人上传歌曲，所有人都能在音乐大厅听到。深色沉浸光效会跟随音乐律动。
...
- **上传**：拖拽/选择音频文件，自动读取标题、歌手、专辑、封面、时长；可附带 `.lrc` 歌词；可选署名
- **沉浸光效**：全屏极光渐变 + 频谱光柱 + 低音光晕 + 漂浮光点，随音乐实时律动，可一键开关
- **歌词**：随播放同步滚动高亮，点击歌词跳转；没有歌词时可在线搜索（lrclib）
- **收藏**：本地收藏夹
- **响应式**：桌面 / 移动端都可用
